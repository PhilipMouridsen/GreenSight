...
function plasticarticle() {
  return (
    <div>
     ...
     <p>When we read about the scale of plastic waste clogging our landfills, and polluting our oceans, it’s tempting to feel overwhelmed, and question whether anything we can personally do would realistically make a difference to this mammoth issue. However, the truth is that even small changes of habit, accumulated over time, add up to a big difference. Then when you factor in that there are lots of like-minded people making the same positive changes as you, to reduce the plastic waste they are creating, you can see that together we can make a massive difference for the better</p>
     <div className="tip">
